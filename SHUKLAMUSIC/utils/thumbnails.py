...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("THAKURMUSIC/assets/assets/font2.ttf", 32)
        regular_font = ImageFont.truetype("THAKURMUSIC/assets/assets/font.ttf", 18)
    except OSError:
    ...
    icons_path = "THAKURMUSIC/assets/assets/play_icons.png"
